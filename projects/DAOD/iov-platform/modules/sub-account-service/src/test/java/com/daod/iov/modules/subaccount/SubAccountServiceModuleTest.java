 ...
 * 子账号服务模块单元测试
 */
@DisplayName("子账号服务模块测试")
class SubAccountServiceModuleTest {
    
    private SubAccountServiceModule module;
    
    @BeforeEach
    void setUp() {
        module = new SubAccountServiceModule();
    }
    ...
    void testMetadata() {
        ...
        assertEquals("sub-account-service", metadata.getName());
