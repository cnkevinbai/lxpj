 ...
 * 告警服务模块单元测试
 */
@DisplayName("告警服务模块测试")
class AlarmServiceModuleTest {
    
    private AlarmServiceModule module;
    
    @BeforeEach
    void setUp() {
        module = new AlarmServiceModule();
    }
    ...
    void testMetadata() {
        ...
        assertEquals("alarm-service", metadata.getName());
