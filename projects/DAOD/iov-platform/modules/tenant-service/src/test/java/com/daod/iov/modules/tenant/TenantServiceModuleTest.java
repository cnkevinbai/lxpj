 ...
 * 租户服务模块单元测试
 */
@DisplayName("租户服务模块测试")
class TenantServiceModuleTest {
    
    private TenantServiceModule module;
    
    @BeforeEach
    void setUp() {
        module = new TenantServiceModule();
    }
    ...
    void testMetadata() {
        ...
        assertEquals("tenant-service", metadata.getName());
