...
const mockData: ProductionTask[] = [
  { id: '1', planId: 'PP20260312001', workcenter: '车间 A', quantity: 200, assignee: '张三', status: 'in_progress', startedAt: '2026-03-14 08:00:00' },
  { id: '2', planId: 'PP20260312001', workcenter: '车间 B', quantity: 300, assignee: '李四', status: 'pending' },
  { id: '3', planId: 'PP20260312002', workcenter: '车间 A', quantity: 150, assignee: '王五', status: 'completed', startedAt: '2026-03-13 08:00:00', completedAt: '2026-03-14 17:00:00' },
  { id: '4', planId: 'PP20260311001', workcenter: '车间 C', quantity: 500, assignee: '赵六', status: 'completed', startedAt: '2026-03-10 08:00:00', completedAt: '2026-03-12 17:00:00' },
]
...
export default function ProductionTask() {
  const [data] = useState<ProductionTask[]>(mockData)
