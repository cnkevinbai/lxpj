...
import { ShoppingCartOutlined, FactoryOutlined, GlobalOutlined, TeamOutlined, FileTextOutlined, SwapOutlined } from '@ant-design/icons'
...
const ERP: React.FC = () => {
  ...
  const modules = [
    ...
    { icon: FactoryOutlined, color: '#faad14', title: '生产管理', path: '/production', desc: '生产工单 / 生产进度 / 质量管理' },
